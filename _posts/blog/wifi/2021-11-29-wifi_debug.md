...
```  
  ![jekyll_exec](/assets/images/wifi_debug/path.png)
...
- pready：队列待push包个数；
- fastready：软加速已缓存包个数；  
![jekyll_exec](/assets/images/wifi_debug/txq.png)
...
![jekyll_exec](/assets/images/wifi_debug/stats.png)
...
![jekyll_exec](/assets/images/wifi_debug/trx.png)
...
![jekyll_exec](/assets/images/wifi_debug/lmactx.png)
...
![jekyll_exec](/assets/images/wifi_debug/lmacrx.png)
...
![jekyll_exec](/assets/images/wifi_debug/hwq.png)
...
![jekyll_exec](/assets/images/wifi_debug/mib.png)
...
![jekyll_exec](/assets/images/wifi_debug/rc.png)
...
- VmallocChunk：表示 malloc 可分配的最大的逻辑连续的内存大小；
  ![jekyll_exec](/assets/images/wifi_debug/meminfo.png)
...
- COMMAND：表示该进程的运行指令；
  ![jekyll_exec](/assets/images/wifi_debug/ps.png)
...
- 第三行进程状态：
  ...
  - %CPU：表示进程CPU占用百分比；
  - COMMAND：表示进程的实际调用指令；
![jekyll_exec](/assets/images/wifi_debug/top.png)
...
- 读：demmev  [寄存器物理地址]  
  如：devmem  0x1110b35c
![jekyll_exec](/assets/images/wifi_debug/read.png)
- 读：demmev  [寄存器物理地址]  32  [要写入的值]
  如：devmem 0x1110b35c 32 0x00010001
![jekyll_exec](/assets/images/wifi_debug/write.png)
...
将2.4G对应的值上调，示例
![jekyll_exec](/assets/images/wifi_debug/CCA.png)
...
示例：
![jekyll_exec](/assets/images/wifi_debug/bw.png)
...
![jekyll_exec](/assets/images/wifi_debug/tx.png)
