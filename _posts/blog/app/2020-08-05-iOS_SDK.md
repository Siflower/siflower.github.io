...
通过SDK提供的API实现对矽昌路由器、AC控制器智能产品在局域网和远程状态下的控制，如WiFi设置、设备管理、网络管理等。
...
在[矽昌开放平台](https://open.siflower.cn/) 注册产品，获取AppKey，AppSecret和productKey。详细参考《 [矽昌开放平台用户手册](https://open.siflower.cn/#/console/documents?id=5d5bb02ffefc6d0001f73d6d) 》5.6产品章节描述。

![create_product](/assets/images/iOS-SDK-UserGuide/ios-sdk-create_product.png)
...
* 通过isSiWiFi接口判断当前手机连接的WiFi是否未矽路由WiFi；
