...
- 配置参数说明中vlan划分WAN-LAN部分可以参考[外围switch芯片对接和使用手册](/_posts/blog/ethernet/2020-09-11-new_switch_import_guide.md)

- wifi的wds功能可以参考[WDS开发及使用手册](/_posts/blog/wifi/2020-09-02-WDS_development_and_user_manual.md)  

- network文件的参数参考[config文件配置手册](/_posts/blog/system/2020-09-11-config_setting.md)
